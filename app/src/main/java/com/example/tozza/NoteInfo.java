...
public final class NoteInfo implements Parcelable {
    ...
    private NoteInfo(Parcel parcel) {
        // when we read a parcelable we have to provide the  class loader,
    ...
    //details of writt ing content into code
    @Override
    ...
    public static final Parcelable.Creator<NoteInfo> CREATOR =
            new Parcelable.Creator<NoteInfo>(){
                @Override
                // create new instance of type and set values using parcel.
                // you must them in the same order as the ones writeToParcel.
